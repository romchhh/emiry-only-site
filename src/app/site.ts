...
export const SITE_TITLE = `${SITE_NAME} | Tokyo Wine Girl`
export const SITE_DESCRIPTION =
  'Emiri Momota — playful Japanese beauty from Tokyo. Wine nights, travel diaries, girlfriend chats, and exclusive lifestyle content. Free trial. No card required.'
...
export const SITE_FAQ = [
  { q: 'Is it really free?', a: 'Yes. You can start with free access — no card required to get in.' },
  {
    ...
    a: 'Tokyo behind-the-scenes, wine and restaurant nights, travel diaries, personal photos, and members-only exclusives you won\'t find on social media.',
  },
  {
